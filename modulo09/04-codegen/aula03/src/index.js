...
const { argv: { componentName }} = yargs(hideBin(process.argv))
    ...
    .command('skeleton', 'create project skeleton', (builder) => {
        return builder
            ...
            .example('skeleton -c product -c person -c colors --component-name product', 'creates a project with a single domain')
    })
    .epilog('copyright 2024 - Rodolpho Porto Corporation')
